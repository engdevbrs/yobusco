    ...
    <>
        <section class="py-5">
                <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-xl-8">
                            <h2 class="fw-bolder mb-3">Cuenta</h2>
                            ...
                            <h2 class="fw-bolder mb-3">Problemas del sitio web</h2>
                            <div class="accordion mb-5 mb-xl-0" id="accordionExample2">
                                <div class="accordion-item">
                                    <h3 class="accordion-header" id="headingOne"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne2" aria-expanded="false" aria-controls="collapseOne2">Accordion Item #1</button></h3>
                                ...
                                <div class="card-body p-4 py-lg-5">
                                    <div class="d-flex align-items-center justify-content-center">
                                        <div class="text-center">
                                            ...
                                            <a class="fs-5 px-2 link-dark" href="#!"><img src={facebook} alt='facebook' style={{'width': '22px'}}/></a>
                                            <a class="fs-5 px-2 link-dark" href="#!"><img src={instagram} alt='instagram' style={{'width': '22px'}}/></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
